...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2025 at 02:39 PM
...
INSERT INTO `appointments` (`b_id`, `user_id`, `fname`, `mname`, `lname`, `suffix`, `email`, `phone`, `gender`, `purpose`, `date`, `time`, `d_id`, `stat`, `created`) VALUES
(1, '47', 'dasdsa', 'das', 'dasdas', 'Jr.', 'dasdsa@gmauikl.com', '0654654654', 'female', 'test', '2025-10-14', '7:00', '55', 'completed', '2025-10-09 13:57:43'),
(2, '47', 'dasdsa', 'das', 'dasdas', 'Jr.', 'dasdsa@gmauikl.com', '0654654654', 'female', 'test', '2025-10-14', '7:00', '55', 'accept', '2025-10-09 13:58:02');
...
--
-- Table structure for table `doc_avail`
--

CREATE TABLE `doc_avail` (
  `id` int(11) NOT NULL,
  `d_id` varchar(255) NOT NULL,
  `date` varchar(255) NOT NULL,
  `time` varchar(255) NOT NULL,
...
--
-- Dumping data for table `doc_avail`
--

INSERT INTO `doc_avail` (`id`, `d_id`, `date`, `time`, `created`) VALUES
(2, '55', '2025-10-16', '7am-5pm', '2025-10-09 20:39:09');
...
(21, 'xray', 'xray for ms  abi', 23, '2025-10-08', 'completed', '2025-10-06 03:20:53'),
(22, 'l', 'l', 23, '2025-10-02', 'completed', '2025-10-06 04:18:27'),
(23, 'l', 'i', 23, '0000-00-00', 'completed', '2025-10-06 04:19:22');
...
(47, 'dasd', 'dasd', 'asdas', 'Jr.', 'user', 'user', '$2y$10$ZonY61lojU63LZXFSlK2YuV6ZaDOVRayUAjQitcDA6jCJjIkUz9vi', 'user', '2025-10-09 02:42:08'),
(55, '', '', '', '', 'doctor1', 'doctor1', '$2y$10$ZonY61lojU63LZXFSlK2YuV6ZaDOVRayUAjQitcDA6jCJjIkUz9vi', 'doctor', '2025-10-09 06:12:48');
...
--
-- Indexes for table `doc_avail`
--
ALTER TABLE `doc_avail`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `doc_avail`
--
ALTER TABLE `doc_avail`
